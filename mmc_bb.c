...
#define	CS_H()	PB.DR.BIT.B3 = 1	/* Set MMC_CS "high" */
#define CS_L()	PB.DR.BIT.B3 = 0	/* Set MMC_CS "low" */
#define CK_H()	PB.DR.BIT.B2 = 1	/* Set MMC_SCLK "high" */
#define	CK_L()	PB.DR.BIT.B2 = 0	/* Set MMC_SCLK "low" */
#define DI_H()	PB.DR.BIT.B1 = 1	/* Set MMC_DI "high" */
#define DI_L()	PB.DR.BIT.B1 = 0	/* Set MMC_DI "low" */
#define DO		PB.DR.BIT.B0		/* Test for MMC_DO ('H':true, 'L':false) */
...
void init_port (void)
{
	...
	PB.DDR = 0xfe;		/* Enable port outputs */
	CS_H();
}
